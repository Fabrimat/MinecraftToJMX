...
public class BungeeJMX implements BungeeJMXMXBeans {
    ...
    public BungeeJMX() {
        ...
        bungeeAdapter = BungeeAdapter.getInstance();
    }
    ...
    private void buildDynamicMBeanInfo() {
        ...
        dConstructors[0] = new MBeanConstructorInfo(
                "BungeeJMX(): No-parameter constructor",  //description
                constructors[0]);                  // the contructor object

        String dDescription = "BungeeJMX";
